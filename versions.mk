...
CONTRAIL_VERSION = 1.10master~$(CONTROLLER_COMMIT_NUMBER)+$(CONTROLLER_REF)
NEUTRON_VERSION = 1.10master~$(NEUTRON_COMMIT_NUMBER)+$(NEUTRON_REF)
WEBUI_VERSION = 1.10master~$(WEBUI_COMMIT_NUMBER)+$(WEBUI_REF)
