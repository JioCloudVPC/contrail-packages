...
CONTRAIL_VERSION = 1.06master~$(CONTROLLER_COMMIT_NUMBER)+$(CONTROLLER_REF)
NEUTRON_VERSION = 1.06master~$(NEUTRON_COMMIT_NUMBER)+$(NEUTRON_REF)
WEBUI_VERSION = 1.06master~$(WEBUI_COMMIT_NUMBER)+$(WEBUI_REF)
